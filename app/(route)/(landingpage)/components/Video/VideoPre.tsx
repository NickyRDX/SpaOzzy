...
export default function VideoPre() {
  return (
    <section className="relative py-10 md:py-10 overflow-x-hidden">
      <MaxWidthWrapper>
        <div>
          <h1 className='text-4xl md:text-3xl font-bold uppercase tracking-tight text-slate-700 underline underline-offset-2 decoration-2 text-center mx-auto max-w-fit text-pretty'>Preview</h1>
        </div>
